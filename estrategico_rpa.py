...
# --- CONFIGURAÇÕES ---
BASE_DIR = r"C:\Users\distr\Desktop\AUTOMAÇÕES\MAIO 2026\ESTRATÉGICOS MAIO"
RANGE_PAINEL = "A1:D78" 
...
equipes = {
    "CLEBSON": {
        "arquivo": "PROD ESTRATEG-CLEBSON MAI26.xlsx",
        "id_grupo": "GnFdjoef19N5lBB87esetG",
        "vendedores": ["AMELIE", "MAURILIO", "DANILO", "DANIEL", "GIOVANI", "PAULO", "DIEGO"]
    },
    "BALCÃO": {
        "arquivo": "PROD ESTRATEG-BALCÃO MAI26.xlsx",
        "id_grupo": "BqHQo56CbLWGfL8jDLqrXJ",
        "vendedores": ["JOELMA", "ANDREA", "LORAINE", "LILLIAN", "VANILDO"]
    },
    "ISAIAS": {
        "arquivo": "PROD ESTRATEG-ISAIAS MAI26.xlsx",
        "id_grupo": "IozGAhS9xwp2AdCCxRsdzq",
        "vendedores": ["JUNIOR", "ELAINE", "LUANA", "GENIVAL", "GILMAR", "ANDRE", "JHONNYS"]
    },
    "FÁBIO": {
        "arquivo": "PROD ESTRATEG-FÁBIO MAI26.xlsx",
        "id_grupo": "Iw1ycaT43ab1JICRQaxwN3",
        "vendedores": ["MARCONDES", "RENATA", "FAUSTO", "SAMUEL", "SIMONE", "DANIEL LIMA", "EDINALDO", "GIVALDO", "ORIOSVALDO", "MARIA EDUARDA", "PAULO"]
    },
    "ADALBERTO": {
        "arquivo": "PROD ESTRATEG-ADALBERTO MAI26.xlsx",
        "id_grupo": "BCNwGQbT53s5QTV8qZCk8i",
        "vendedores": ["PATRICIA ADRIANA", "RONILSON", "BRUNO", "GABRIEL CARLOS", "MARCIANO", "P HENRIQUE", "EVERTON", "IGO"]
    },
    "IVAN": {
        "arquivo": "PROD ESTRATEG-IVAN MAI26.xlsx",
        "id_grupo": "I9j342H2UZ1AaUfDc0XwCi",
        "vendedores": ["ALEXANDRE", "ALMIR", "M ADELINO", "M LIMA", "PATRICIA", "J FRANCISCO", "JACKSON", "GLAYDSON", "DEIVISON"]
    },
    "RONALDO": {
        "arquivo": "PROD ESTRATEG-RONALDO MAI26.xlsx",
        "id_grupo": "J4iaDNclmwK708RHi7elZp",
        "vendedores": ["J ARAUJO", "J THIAGO", "DIEGO", "J FABIO", "VALTER", "GABRIEL", "MOACIR", "PEDRO", "J NILTON", "VANDAME", "SAVIO", "LUCELIA", "FLAVIO"]
    }
}
...
try:
    ...
    for equipe_key, meta in equipes.items():
        ...
        pyautogui.write("Segue a Parcial de Produtos Estrategicos!")
        time.sleep(1)
